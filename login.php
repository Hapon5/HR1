...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($EmailErr) && empty($passwordErr)) {
        ...
        $check_Email = mysqli_query($Connections, "SELECT * FROM logintbl WHERE Email = '$Email'");
    ...
    <style>
        * {
        ...
        .input-box input:focus {
            border-color: #d37a15ff;
            box-shadow: 0 0 5px rgba(236, 164, 56, 0.5);
        }
        ...
        .info-section {
            flex: 1;
            background: linear-gradient(to bottom right, #d37a15ff, #d37a15ff); /* Updated gradient */
            color: white;
            padding: 40px 30px;
            display: flex;
            flex-direction: column;
